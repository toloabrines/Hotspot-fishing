#!/bin/bash
# Script de configuración de secrets para GitHub Actions
# Este script te GUÍA para configurar los secrets correctamente
# ⚠️  NO ejecutes este script directamente
# Solo úsalo como referencia para configurar manualmente
...
echo "└─────────────────────────────────────────────────────────┘"
echo ""
read -p "Presiona ENTER después de crear APPLE_ID..."
...
echo "└─────────────────────────────────────────────────────────┘"
echo ""
read -p "Presiona ENTER después de crear APPLE_PASSWORD..."
...
echo "└─────────────────────────────────────────────────────────┘"
echo ""
read -p "Presiona ENTER después de crear APPLE_TEAM_ID..."
...
echo "└─────────────────────────────────────────────────────────┘"
echo ""
read -p "Presiona ENTER después de crear APPLE_ITC_TEAM_ID..."
